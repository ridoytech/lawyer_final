                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    <table class="table table-hover mb-0 c_list">
                                        ...
                                        <?php
                                            $project = $mysqli->query("SELECT * FROM lawyer_image");
                                            while ($row = $project->fetch_assoc()):
                                            ?>

                                            <tr>
                                                <td><img style="width: 80px;" src="ImageGallery/<?php echo ($row['image']) ?>" alt=""></td>
                                                <td><?php echo ($row['image_title']) ?></td>

                                                <td>
                                                    <a href="updateGalleryImage.php?image_id=<?php echo $row['id']; ?>" type="submit" class="btn btn-info" title="Edit"><i class="fa fa-edit"></i></a>
                                                    <a href="logics.php?image_id=<?php echo $row['id']; ?>" type="submit" data-type="confirm" class="btn btn-danger js-sweetalert"  title="Delete"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php endwhile; ?>
                                        </tbody>
                        ...
                        <div class="card">
                            <div class="body">
                                <form action="logics.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <h6><strong>Add Images </strong></h6>
                                    <hr>
                                    <div class="row clearfix">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <input type="file" name="image" class="form-control" placeholder="Type Image Title">
                                            </div>
                                        </div>
                                    ...
                                    <button type="submit" name="add_gallery_image" class="btn btn-success">Add Image</button>
                                </form>
                            </div>
                        </div>
                    </div>
