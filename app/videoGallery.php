                            ...
                            <div class="body">
                                <div class="table-responsive">
                                    <table class="table table-hover mb-0 c_list">
                                        ...
                                        <?php
                                            $project = $mysqli->query("SELECT * FROM lawyer_video");
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="updateVideoGallery.php?video_id=<?php echo $row['id']; ?>" type="submit" class="btn btn-info" title="Edit"><i class="fa fa-edit"></i></a>
                                                    <a href="logics.php?video_id=<?php echo $row['id']; ?>" type="submit" data-type="confirm" class="btn btn-danger js-sweetalert"  title="Delete"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php endwhile; ?>
                                        </tbody>
                        ...
                        <div class="card">
                            <div class="body">
                                <form action="logics.php" method="post" >
                                    ...
                                    <h6><strong>Add Videos </strong></h6>
                                    <hr>
                                    ...
                                    <button type="submit" name="add_gallery_video" class="btn btn-success">Add Image</button>
                                </form>
                            </div>
                        </div>
                    </div>
