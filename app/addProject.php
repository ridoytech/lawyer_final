                            ...
                            <form action="logics.php" method="post" enctype="multipart/form-data" >
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="Settings">
                                        ...
                                        <div class="body">
                                            <h6><strong>Doctor Personal Information</strong></h6>
                                            <hr>
                                            <div class="row clearfix">
                                                <div class="col-lg-4 col-md-12">
                                                    <div class="form-group">
                                                        <input type="text" name="project_title"   class="form-control" placeholder=" Type Project Name">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-12">
                                                    <div class="form-group">
                                                        <input type="text" name="project_link"  class="form-control" placeholder="Type Project Link">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-12">
                                                    <div class="form-group">
                                            ...
                                            <button type="submit" name="add_project" class="btn btn-success">Submit Project</button>
